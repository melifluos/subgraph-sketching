...
class HashingTests(unittest.TestCase):
    ...
    def test_get_features(self):
        ...
        features = {LABEL_LOOKUP[max_hops][idx]: val for idx, val in enumerate(tmp_features)}
        # test (1,1) features
    ...
    def test_subgraph_features(self):
        ...
        features = {LABEL_LOOKUP[self.args.max_hash_hops][idx]: val for idx, val in enumerate(tmp_features.flatten())}
        # test (1,1) features
        int11 = neighbors11.intersection(neighbors21)
        self.assertTrue(isclose(len(int11), features[(1, 1)], abs_tol=1))
        # test (2,1) features
