...
python runners/run.py --dataset ogbl-collab --K 50 --lr 0.01 --feature_dropout 0.05 --add_normed_features 1 --label_dropout 0.1 --year 2007 --model ELPH
python runners/run.py --dataset ogbl-collab --K 50 --lr 0.01 --feature_dropout 0.05 --add_normed_features 1 --cache_subgraph_features --label_dropout 0.1 --year 2007 --model BUDDY
